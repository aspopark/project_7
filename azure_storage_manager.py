...
class AzureStorageManager:
    def __init__(self):
        try:
            ...
            logging.error(f"Azure Storage 연결 오류: {e}")
    ...
    def _create_containers_if_not_exist(self):
        ...
        for container_name, client in [
            ...
            try:
                ...
                # 'ContainerAlreadyExists' 오류는 무시합니다.
                if "ContainerAlreadyExists" not in str(e): 
                    logging.error(f"컨테이너 '{container_name}' 생성 오류: {e}")
                else:
                    logging.info(f"컨테이너 '{container_name}'가 이미 존재합니다.")
    ...
    def upload_file(self, file_content: str, blob_name: str, container_client) -> bool:
        ...
        try:
            ...
            logging.error(f"'{blob_name}' 파일 업로드 오류: {e}")
            return False
    ...
    def download_file(self, blob_name: str, container_client) -> str | None:
        ...
        try:
            ...
            logging.error(f"'{blob_name}' 파일 다운로드 오류: {e}")
            return None
    ...
    def list_definitions(self) -> list[str]:
        ...
        try:
            ...
            logging.error(f"정의 파일 목록 가져오기 오류: {e}")
            return []
